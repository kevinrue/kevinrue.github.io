...
:::
::: {.cv-description}
Nineteen days of hands-on training covering Linux and R programming for genomic and single-cell data analysis (8 participants).
:::
:::
...
:::
::: {.cv-description}
Twenty days of hands-on training covering Linux and R programming for genomic and single-cell data analysis (8 participants).
:::
:::
